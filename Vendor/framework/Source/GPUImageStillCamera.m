...
@property (nonatomic, assign) UIDeviceOrientation lastInterfaceDeviceOrientation;
...
//    if (captureAsYUV && [GPUImageContext supportsFastTextureUpload])
    ...
    self.lastInterfaceDeviceOrientation = [UIDevice currentDevice].orientation;
...
- (UIImage *) imageFromSampleBuffer:(CMSampleBufferRef) sampleBuffer
{
    ...
    switch (deviceOrientation) {
        ...
        case UIDeviceOrientationFaceDown:
            deviceOrientation = self.lastInterfaceDeviceOrientation;
            break;
    ...
    UIImage *image = [[UIImage alloc] initWithCGImage:quartzImage scale:1 orientation:imageOrientation];
