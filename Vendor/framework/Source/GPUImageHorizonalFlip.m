...
NSString *const kGPUImageHorizontalFilterFragmentShaderString =  SHADER_STRING
(
...
@interface GPUImageHorizonalFlip ()
...
@implementation GPUImageHorizonalFlip
...
{
    if (!(self = [super initWithFragmentShaderFromString:kGPUImageHorizontalFilterFragmentShaderString]))
    {
        return nil;
    }
